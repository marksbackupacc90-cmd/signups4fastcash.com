    ...
    <section className="relative overflow-hidden px-4 py-8 sm:px-6 lg:px-8" id="games">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div className="flex items-start gap-2 rounded-2xl border border-amber-300/15 bg-amber-300/[0.04] p-4 text-xs leading-relaxed text-amber-100/70"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-amber-200" /><span><strong className="text-amber-100">Demo mode only.</strong> Wilds trigger free spins, and every wild in the chain adds another free spin. Credits have no cash value and cannot be purchased.</span><Info className="mt-0.5 ml-auto h-4 w-4 shrink-0 text-amber-200/70" /></div>
        </div>
      </div>
    </section>
  );
