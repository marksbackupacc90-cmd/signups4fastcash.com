...
export const SfcCoinLogo: React.FC<SfcCoinLogoProps> = ({ size = 'md' }) => {
  ...
  return (
    ...
    >
      ...
      <text x="50" y="57" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="23" fontWeight="900" letterSpacing="-1" fill={`url(#${id}-letter)`} stroke="#052e16" strokeWidth=".7" paintOrder="stroke">SFC</text>
