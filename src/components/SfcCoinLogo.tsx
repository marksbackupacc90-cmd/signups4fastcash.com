...
export const SfcCoinLogo: React.FC<SfcCoinLogoProps> = ({ size = 'md' }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="5" y="5" width="90" height="90" rx="25" fill="#07111f" stroke="#164e7a" strokeWidth="3" />
      ...
      <text x="50" y="59" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="25" fontWeight="900" letterSpacing="-1.5" fill="#ffffff" stroke="#172554" strokeWidth="1.2" paintOrder="stroke">S4FC</text>
      <circle cx="76" cy="24" r="4" fill="#bef264" />
    </svg>
  );
};
