...
export const SfcCoinLogo: React.FC<SfcCoinLogoProps> = ({ size = 'md' }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="5" y="5" width="90" height="90" rx="25" fill="#08131d" stroke="#2dd4ee" strokeWidth="3" />
      ...
      <text x="50" y="59" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="25" fontWeight="900" letterSpacing="-1.5" fill="#f4f7ed" stroke="#0f766e" strokeWidth="1.2" paintOrder="stroke">S4FC</text>
      <circle cx="76" cy="24" r="4" fill="#7dd3fc" />
    </svg>
  );
};
