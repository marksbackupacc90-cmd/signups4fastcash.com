...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  metaTitle: 'Best Signup Bonuses & Cashback Offers | Signups4FastCash.com',
  metaDescription: 'Compare referral deals, cash bonuses, and no-deposit offers across fintech, free stock, cashback apps, and crypto promotions before you sign up.',
